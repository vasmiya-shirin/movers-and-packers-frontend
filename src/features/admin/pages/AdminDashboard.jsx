            ...
            >
              ...
              <td className="p-2 font-semibold">
                <span
                  ...
                  } ${b.status === "Accepted" && "bg-blue-500"} ${
                    b.status === "In Progress" && "bg-yellow-500"
                  } ${b.status === "Completed" && "bg-purple-500"} ${
                    b.status === "Approved" && "bg-green-600"
...
const AllServices = ({ services, navigate, deleteService }) => (
  <div className="bg-white dark:bg-gray-800 shadow rounded-xl p-6 mb-10">
