  ...
  return (
    <header className="bg-white dark:bg-gray-900 shadow-md dark:shadow-gray-700 fixed w-full z-50">
      <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
        ...
        >
          Movers
          <span className="text-gray-700 dark:text-gray-300">Packers</span>
        </Link>
          ...
          {!token ? (
            ...
            <>
              ...
              <button
                ...
                className="px-4 py-2 bg-red-500 text-white font-medium rounded-lg cursor-pointer hover:bg-red-700 transition"
              >
                Logout
              </button>
            </>
      ...
      <div
        ...
        } md:hidden bg-white dark:bg-gray-900 shadow-md border-t dark:border-gray-700`}
      >
            ...
            {!token ? (
              ...
              <>
                <Link
                  ...
                  className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 text-center transition"
                  onClick={() => setMenuOpen(false)}
                >
                  Dashboard
                </Link>
                <button
                  ...
                  className="px-4 py-2 border rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 text-center transition"
                >
                  Logout
                </button>
              </>
